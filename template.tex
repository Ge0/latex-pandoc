...
\usepackage[paperwidth=11cm,paperheight=18cm,top=1cm,left=1cm,right=1cm,bottom=1cm]{geometry}
...
\newgeometry{paperwidth=11cm,paperheight=18cm,top=1cm,left=1cm,right=1cm,bottom=1.5cm,bindingoffset=0.5cm}
...
\newgeometry{paperwidth=11cm,paperheight=18cm,top=1cm,left=1cm,right=1cm,bottom=1cm}
...
%\newgeometry{paperwidth=11cm,paperheight=18cm,top=1cm,left=1.5cm,right=1cm,bottom=1.5cm}
$body$
